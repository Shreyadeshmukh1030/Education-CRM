...
models = {
    'exam': {'title': 'Exams', 'fields': ['title', 'class_assigned', 'subject', 'date', 'max_marks'], 'obj': 'exam'},
}
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--border-color); transition: background-color var(--transition-fast);">
                    ...
                    <td style="padding: 15px 20px; text-align: right;">
                        <a href="{{% url '{model}_results_mark' {obj}.pk %}}" class="btn btn-sm" style="background-color: var(--primary-color); color: white; padding: 4px 8px; border-radius: 4px; text-decoration: none; font-size: 0.8rem; margin-right: 10px;">Mark Results</a>
...
print("Exam templates generated successfully!")
